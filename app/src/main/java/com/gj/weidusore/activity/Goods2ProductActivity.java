...
import com.gj.weidusore.core.IdeaScrollView;
import com.gj.weidusore.core.IdeaViewPager;

import java.util.ArrayList;

import qiu.niorgai.StatusBarCompat;

public class Goods2ProductActivity extends AppCompatActivity {

   /* @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_goods2_product);
    }*/
