...
/** 
 * DAO for table "USER_INFO_LOGIN".
*/
public class UserInfoLoginDao extends AbstractDao<UserInfoLogin, Long> {

    public static final String TABLENAME = "USER_INFO_LOGIN";

    /**
     * Properties of entity UserInfoLogin.<br/>
    ...
    public UserInfoLoginDao(DaoConfig config) {
        super(config);
    }
    
    public UserInfoLoginDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USER_INFO_LOGIN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"USER_INFO_LOGIN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, UserInfoLogin entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, UserInfoLogin entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getUserId());
    ...
    @Override
    public UserInfoLogin readEntity(Cursor cursor, int offset) {
        UserInfoLogin entity = new UserInfoLogin( //
    ...
    @Override
    public void readEntity(Cursor cursor, UserInfoLogin entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(UserInfoLogin entity, long rowId) {
        entity.setUserId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(UserInfoLogin entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(UserInfoLogin entity) {
